...
\midrule
Chain dummy                   & $0.048^{**}$  & (0.013) \\
Number competing outlets      & $-0.035^{*}$  & (0.004) \\
Number co-owned outlets       & $0.025^{**}$  & (0.009) \\
Distance to competitor        & $0.028^{*}$   & (0.014) \\
Distance to co-owned outlet   & $-0.012^{*}$  & (0.006) \\
Drive-thru dummy              & 0.014         & (0.014) \\
Population density            & $0.396^{**}$  & (0.167) \\
Worker density                & $-0.343^{*}$  & (0.143) \\
\midrule
$R^2$                         & 0.513         &         \\
\bottomrule
\end{tabularx}
